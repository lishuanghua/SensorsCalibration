...
public:
    ...
    extractor(Mat img1_bev, Mat img2_bev, Mat intrinsic1, Mat intrinsic2, Eigen::Matrix4d extrinsic1, Eigen::Matrix4d extrinsic2);
    ~extractor();
    void Binarization();
    ...
    vector<cv::Point> extrac_textures_and_save(string pic_filename, string csv_filename, string idx, double size);
