...
double CameraOptimization(Optimizer &opt, string cameraType)
{
    ...
    if (cameraType == "right")
    {
        threads_[0] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums_, -1, 1, -1, 1,
                             -1, 1, -0.005, 0.005, -0.005, 0.005, -0.005, 0.005);
        threads_[1] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums_, -0.5, 0.5,
    ...
    {
        threads_[0] = thread(&Optimizer::fine_Calibrate_left, &opt, iter_nums_, -1, 1, -1, 1,
                             -1, 1, -0.005, 0.005, -0.005, 0.005, -0.005, 0.005);
        threads_[1] = thread(&Optimizer::fine_Calibrate_left, &opt, iter_nums_, -0.5, 0.5,
                             -0.5, 0.5, -0.5, 0.5, -0.01, 0.01, -0.01, 0.01, -0.01, 0.01);
    ...
    {
        threads_[0] = thread(&Optimizer::fine_Calibrate_behind, &opt, iter_nums_, -1, 1, -1,
                             1, -1, 1, -0.005, 0.005, -0.005, 0.005, -0.005, 0.005);
        threads_[1] = thread(&Optimizer::fine_Calibrate_behind, &opt, iter_nums_, -0.5, 0.5,
                             -0.5, 0.5, -0.5, 0.5, -0.01, 0.01, -0.01, 0.01, -0.01, 0.01);
