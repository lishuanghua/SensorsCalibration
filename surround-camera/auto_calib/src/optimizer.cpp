...
Mat Optimizer::tail(Mat img, string index)
{
    if (index == "f")
    {
        ...
        Mat border(img.rows - sizef, img.cols, cropped_image_f.type(), Scalar(0, 0, 0));
        Mat dst_front;
    ...
    else if (index == "l")
    {
        ...
        Mat border2(img.rows, img.cols - sizel, cropped_image_l.type(), Scalar(0, 0, 0));
        Mat dst_left;
    ...
    else if (index == "b")
    {
        ...
        Mat border1(img.rows - sizeb, img.cols, cropped_image_b.type(), Scalar(0, 0, 0));
        Mat dst_behind;
    ...
    else if (index == "r")
    {
        ...
        Mat border3(img.rows, img.cols - sizer, cropped_image_r.type(), Scalar(0, 0, 0));
        Mat dst_right;
...
void Optimizer::initializeK()
{
    ...
    {
        K_F << 390.425287, 0.00000000, 750, 0.00000000, 390.425287, 750, 0.00000000, 0.00000000, 1.00000000;
        K_L << 390.425287, 0.00000000, 750, 0.00000000, 390.425287, 750, 0.00000000, 0.00000000, 1.00000000;
        K_B << 390.425287, 0.00000000, 750, 0.00000000, 390.425287, 750, 0.00000000, 0.00000000, 1.00000000;
        K_R << 390.425287, 0.00000000, 750, 0.00000000, 390.425287, 750, 0.00000000, 0.00000000, 1.00000000;
    }

    // fisheye
    if (data_index == "fisheye")
    {
        K_F << 422.13163849, 0.00000000, 612.82890504, 0.00000000, 421.10340889, 545.05656249, 0.00000000, 0.00000000, 1.00000000;
        K_L << 420.60079305, 0.00000000, 650.54173853, 0.00000000, 418.94827188, 527.27178143, 0.00000000, 0.00000000, 1.00000000;
        K_B << 422.61569350, 0.00000000, 632.46019501, 0.00000000, 421.27373079, 548.34673288, 0.00000000, 0.00000000, 1.00000000;
        K_R << 421.64203585, 0.00000000, 640.09362064, 0.00000000, 420.26647020, 529.05566315, 0.00000000, 0.00000000, 1.00000000;
    }
...
{ // ground->camera
    ...
    if (data_index == "fisheye")
    {
        T_FG << 9.99277118e-01, 3.82390286e-04, -3.80143958e-02, 6.75437418e-01,
            ...
            -3.02124625e-02, 6.14928921e-01, -7.88003572e-01, 3.17779305e+00, 0, 0, 0, 1;
        T_LG << -1.21898860e-02, 9.99924056e-01, -1.81349393e-03, 1.36392943e+00,
            ...
            -5.96711036e-01, -8.72966581e-03, -8.02408707e-01, 1.04105913e+01, 0, 0, 0, 1;
        T_BG << -9.99615699e-01, 1.56439861e-02, -2.28849354e-02, 1.09266953e+00,
            ...
            9.64060983e-03, -5.77827838e-01, -8.16101739e-01, 6.60957845e+00, 0, 0, 0, 1;
        T_RG << 4.57647596e-03, -9.99989102e-01, 9.22798184e-04, -1.66115120e-01,
            ...
            7.79533797e-01, 2.98955282e-03, -6.26353033e-01, 6.08338205e+00, 0, 0, 0, 1;
    }
    ...
    cout << "eular:" << endl
         << TransformUtil::Rotation2Eul(extrinsic_front.block(0, 0, 3, 3)) << endl;
    ...
    cout << "eular:" << endl
         << TransformUtil::Rotation2Eul(extrinsic_right.block(0, 0, 3, 3)) << endl;
    cout << "extrinsic_behind:" << endl
         << extrinsic_behind << endl;
    cout << "eular:" << endl
         << TransformUtil::Rotation2Eul(extrinsic_behind.block(0, 0, 3, 3)) << endl;
...
void Optimizer::initializeKG()
{
    ...
    if (data_index == "common")
    {
        K_G << 390.425287, 0.00000000, 750, 0.00000000, 390.425287, 750, 0.00000000, 0.00000000, 1.00000000;
        KG = K_G;
    }
...
Optimizer::Optimizer(
    const Mat *imgf, const Mat *imgl, const Mat *imgb,
...
Mat Optimizer::project_on_ground(
    Mat img, Eigen::Matrix4d T_CG,
    ...
    float height)
{
    ...
    Mat K_C_ = (Mat_<double>(3, 3) << K_C(0, 0), K_C(0, 1), K_C(0, 2), K_C(1, 0), K_C(1, 1), K_C(1, 2), K_C(2, 0), K_C(2, 1), K_C(2, 2));
...
void Optimizer::Calibrate_left(
    int search_count, double roll_ep0,
    ...
    double t1_ep1, double t2_ep0, double t2_ep1)
{
    ...
    random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0, pitch_ep1,
                         yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "left");
}

void Optimizer::Calibrate_right(
    int search_count, double roll_ep0,
    double roll_ep1, double pitch_ep0,
    ...
    double t2_ep1)
{
    ...
    random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0, pitch_ep1,
                         yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "right");
}

void Optimizer::Calibrate_behind(
    int search_count, double roll_ep0,
    double roll_ep1, double pitch_ep0,
    double pitch_ep1, double yaw_ep0,
    double yaw_ep1, double t0_ep0, double t0_ep1,
    ...
    double t2_ep1)
{
    ...
    random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0, pitch_ep1,
                         yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "behind");
}

void Optimizer::Calibrate_front(
    int search_count, double roll_ep0,
    double roll_ep1, double pitch_ep0,
    double pitch_ep1, double yaw_ep0,
    double yaw_ep1, double t0_ep0, double t0_ep1,
    ...
    double t2_ep1)
{
    ...
    random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0, pitch_ep1,
                         yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "front");
}

void Optimizer::fine_Calibrate_left(
    int search_count, double roll_ep0,
    double roll_ep1, double pitch_ep0,
    double pitch_ep1, double yaw_ep0,
    ...
    double t2_ep0, double t2_ep1)
{
    fine_random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0,
                              pitch_ep1, yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "left");
}
...
{
    fine_random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0,
                              pitch_ep1, yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "right");
}
...
{
    fine_random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0,
                              pitch_ep1, yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "behind");
}
...
{
    fine_random_search_params(search_count, roll_ep0, roll_ep1, pitch_ep0,
                              pitch_ep1, yaw_ep0, yaw_ep1, t0_ep0, t0_ep1, t1_ep0, t1_ep1, t2_ep0, t2_ep1, "front");
}
...
double Optimizer::back_camera_and_compute_loss(Mat img1, Mat img2, Eigen::Matrix4d T, string idx)
{
    vector<Point> pixels;
    Eigen::Matrix3d KC;
    vector<double> DC;
    ...
    for (int i = 0; i < size; i++)
    {
        ...
        {
            loss += pow(fabs(getPixelValue(&img1, x, y) / ncoef - getPixelValue(&img2, x1, y1)), 2);
        }
        else
        {
            failcount++;
...
void Optimizer::random_search_params(
    int search_count, double roll_ep0,
    double roll_ep1, double pitch_ep0,
    double pitch_ep1, double yaw_ep0,
    double yaw_ep1, double t0_ep0,
    ...
    double t2_ep1, string idx)
{
    ...
    if (idx == "left")
    {
        imgl_bev = project_on_ground(imgl_gray, extrinsic_left_opt, intrinsic_left, distortion_params_left, KG, brows, bcols, hl);
    ...
    {
        imgr_bev = project_on_ground(imgr_gray, extrinsic_right_opt, intrinsic_right, distortion_params_right, KG, brows, bcols, hr);
    ...
    {
        imgb_bev = project_on_ground(imgb_gray, extrinsic_behind_opt, intrinsic_behind, distortion_params_behind, KG, brows, bcols, hb);
    ...
    { // if fix back camera,front camera is calibrated at last
        imgf_bev = project_on_ground(imgf_gray, extrinsic_front_opt, intrinsic_front, distortion_params_front, KG, brows, bcols, hf);
        imgf_bev_rgb = project_on_ground(imgf_rgb, extrinsic_front_opt, intrinsic_front, distortion_params_front, KG, brows, bcols, hb);
        imgf_bev = tail(imgf_bev, "f");
        imgf_bev_rgb = tail(imgf_bev_rgb, "f");
    }
}

void Optimizer::fine_random_search_params(
    int search_count, double roll_ep0,
    double roll_ep1, double pitch_ep0,
    double pitch_ep1, double yaw_ep0,
    double yaw_ep1, double t0_ep0,
    ...
    double t2_ep1, string idx)
{
    ...
    else if (idx == "right")
    {
        imgr_bev = project_on_ground(imgr_gray, extrinsic_right_opt, intrinsic_right, distortion_params_right, KG, brows, bcols, hr);
        imgr_bev_rgb =
            project_on_ground(imgr_rgb, extrinsic_right_opt, intrinsic_right, distortion_params_right, KG, brows, bcols, hr);
        imgr_bev = tail(imgr_bev, "r");
        imgr_bev_rgb = tail(imgr_bev_rgb, "r");
    }
    else if (idx == "behind")
