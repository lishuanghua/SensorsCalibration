...
double CameraOptimization(Optimizer &opt, string cameraType)
{
    ...
    if (cameraType == "right")
    {
        threads_[0] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums_,
                             -1, 1, -1, 1, -1, 1, -0.005, 0.005, -0.005, 0.005, -0.005, 0.005);
        threads_[1] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums_,
                             -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.01, 0.01, -0.01, 0.01, -0.01, 0.01);
        threads_[2] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums_,
                             -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.005, 0.005, -0.005, 0.005, -0.005, 0.005);
    ...
    {
        threads_[0] = thread(&Optimizer::fine_Calibrate_left, &opt, iter_nums_,
                             -1, 1, -1, 1, -1, 1, -0.005, 0.005, -0.005, 0.005, -0.005, 0.005);
        threads_[1] = thread(&Optimizer::fine_Calibrate_left, &opt, iter_nums_,
                             -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.01, 0.01, -0.01, 0.01, -0.01, 0.01);
    ...
    {
        threads_[0] = thread(&Optimizer::fine_Calibrate_behind, &opt, iter_nums_,
                             -1, 1, -1, 1, -1, 1, -0.005, 0.005, -0.005, 0.005, -0.005, 0.005);
        threads_[1] = thread(&Optimizer::fine_Calibrate_behind, &opt, iter_nums_,
                             -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.01, 0.01, -0.01, 0.01, -0.01, 0.01);
    ...
    if (cameraType == "right")
    {
        threads__[0] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums__,
                              -0.01, 0.01, -0.01, 0.01, -0.01, 0.01, -0.002, 0.002, -0.002, 0.002, -0.002, 0.002);
        threads__[1] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums__,
                              -0.01, 0.01, -0.01, 0.01, -0.01, 0.01, -0.001, 0.001, -0.001, 0.001, -0.001, 0.001);
        threads__[2] = thread(&Optimizer::fine_Calibrate_right, &opt, iter_nums__,
                              -0.01, 0.01, -0.01, 0.01, -0.01, 0.01, -0.001, 0.01, -0.001, 0.001, -0.001, 0.001);
    }
    else if (cameraType == "left")
    {
...
int main()
{
    ...
    Optimizer opt(&imgf, &imgl, &imgb, &imgr, camera_model, bev_rows, bev_cols, fixed, coarse_search_flag, data_set);
    ...
    Mat GL = opt.project_on_ground(
        imgl, opt.extrinsic_left, opt.intrinsic_left,
    ...
    ext1.Binarization();
    ext1.findcontours();
    opt.fl_pixels_texture = ext1.extrac_textures_and_save(opt.prefix + "/texture_fl.png", opt.prefix + "/fl.csv", "fl", opt.sizef);
    ...
    ext2.Binarization();
    ext2.findcontours();
    opt.fr_pixels_texture = ext2.extrac_textures_and_save(opt.prefix + "/texture_fr.png", opt.prefix + "/fr.csv", "fr", opt.sizef);
    ...
    ext3.Binarization();
    ext3.findcontours();
    opt.bl_pixels_texture = ext3.extrac_textures_and_save(opt.prefix + "/texture_bl.png", opt.prefix + "/bl.csv", "bl", opt.sizel);
    ...
    ext4.Binarization();
    ext4.findcontours();
    opt.br_pixels_texture = ext4.extrac_textures_and_save(opt.prefix + "/texture_br.png", opt.prefix + "/br.csv", "br", opt.sizer);
