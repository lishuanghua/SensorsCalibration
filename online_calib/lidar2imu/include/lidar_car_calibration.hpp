...
namespace autoCalib
{
    namespace calibration
    {
        ...
        public:
            ...
            void setCarPose(const std::vector<double> &timestamp, const std::vector<Eigen::Matrix4d> &pos_vec)
            {
                car_pos_idx_ = 0;
                car_pos_idx_1 = 0;
            ...
            bool inputLidar(const double &timestamp, PointCloud::Ptr in_cloud);
            bool inputLidarT(const double &timestamp, PointCloud::Ptr cloud);
