    ...
    namespace calibration
    {
        ...
        public:
            ...
            static bool timeString2timecount(const std::string &time_string, double &time_count_s)
            {
                ...
                {
                    LOGW("Convert %s to tm struct failed, please check time format!", time_string.substr(0, 19).c_str());
            ...
            static bool timeString2timecount_2(const std::string &time_string, double &time_count_s)
            {
                ...
                std::string new_string = elements[0] + "-" + elements[1] + "-" + elements[2] + " " + elements[3] + ":" +
            ...
            static bool getExtrinsic(const std::string &json_path, Eigen::Matrix4d &extrinsic)
            {
                Json::Reader reader;
                Json::Value root;
