...
namespace autoCalib
{
    namespace calibration
    {
        ...
        bool HandEyeCalibration::calibrate(const Eigen::Matrix3d &lidar_rot, const Eigen::Matrix3d &car_rot, Eigen::Matrix3d &calib_r_result)
        {
            frame_count++;
        ...
        bool HandEyeCalibration::calibrate(
            ...
            const Eigen::Matrix3d &calib_r_result, Eigen::Vector3d &calib_tic_result)
        {
            ...
            if (cflag)
            {
                ...
                Rlidar.push_back(Eigen::Matrix3d::Identity());
                Rcar.push_back(Eigen::Matrix3d::Identity());
                Plidar.push_back(Eigen::Vector3d::Zero());
                Pcar.push_back(Eigen::Vector3d::Zero());
            }
