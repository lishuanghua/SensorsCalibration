...
int main(int argc, char **argv)
{
    ...
    {
        if (ESTIMATE_EXTRINSIC == 0 && ESTIMATE_EXTRINSICT == 0)
        {
            break;
        }
    ...
    out_file << ypr_result(0) << " " << ypr_result(1) << " " << ypr_result(2) << std::endl;
    out_file << "Position:" << std::endl;
    out_file << t_result(0) << " " << t_result(1) << " " << t_result(2) << std::endl;

    out_file << "\nground truth:" << std::endl;
    out_file << estimator.estimated_gt << std::endl;
    out_file << "YPR:" << std::endl;
    out_file << ypr_gt(0) << " " << ypr_gt(1) << " " << ypr_gt(2) << std::endl;
    // out_file << t_gt(0) << " " << t_gt(1) << " " << t_gt(2) << std::endl;
