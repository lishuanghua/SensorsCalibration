...
int main(int argc, char **argv)
{
    ...
    std::cout << "Before pangolin::CreateWindowAndBind()" << std::endl;
    pangolin::CreateWindowAndBind("lidar2camera player", width, height);
    std::cout << "After pangolin::CreateWindowAndBind()" << std::endl;
    ...
    pangolin::Var<bool> displayMode("cp.Intensity Color", false, true); // logscale
