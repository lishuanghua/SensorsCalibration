                                     ...
                                     const int &corner_height)
{
    ...
    for (size_t i = 0; i < file_names.size(); i++)
    {
        ...
        bool whether_found = cv::findChessboardCorners(input_image, corner_size_, image_corners);
    ...
    cv::calibrateCamera(object_points_, image_points_, img_size_, camera_intrinsic_, camera_dist_, R_mats_, t_mats_);
...
bool IntrinsicCalibration::undistortSingleImage(const std::string &image_path, const std::string &output_image_path)
{
