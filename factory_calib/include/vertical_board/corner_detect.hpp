...
namespace cameracalib
{
    namespace verticalBoard
    {
        ...
        {
            CalibrationParam() : angle_diff_th(3), dist_diff_th(0.3), min_dist_th(15), max_dist_th(100) {}
        ...
        public:
            CornerDetector() {}
            bool detect(const std::vector<std::vector<float>> &gray_img, const VerticalBoard &lp, CornerPoints *corner_pts);
