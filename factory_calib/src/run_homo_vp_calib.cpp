...
int main(int argc, char **argv)
{
    ...
    if (type == 0)
    {
        sta = calibrator.ChessBoardCalibration(gray_vec, params, output_dir, &outputs);
    }
    else if (type == 1)
    {
        sta = calibrator.VerticalBoardCalibration(gray_vec, params, output_dir, &outputs);
    }
    else if (type == 2)
    {
        sta = calibrator.CircleBoardCalibration(gray_vec, params, output_dir, &outputs);
    }
    else if (type == 3)
    {
