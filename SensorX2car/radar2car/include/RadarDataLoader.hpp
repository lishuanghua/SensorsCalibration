...
namespace autoCalib
{
    namespace calibration
    {
        ...
        private:
            void preLoadImu(const std::string &novatel_enu, std::vector<ImuFrame> &imu_frames, double start_sec, double max_sec);

            bool getStraightSegment(const std::vector<ImuFrame> &imu_frames, std::vector<std::vector<int>> &segment_idxs);
